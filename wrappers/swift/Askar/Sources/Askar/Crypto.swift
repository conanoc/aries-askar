...
public class EcdhEs {
    ...
    private func deriveKey(encAlg: KeyAlg, ephemeralKey: Key, receiverKey: Key, receive: Bool) throws -> Key {
...
public class Ecdh1PU {
    ...
    private func deriveKey(encAlg: KeyAlg, ephemeralKey: Key, senderKey: Key, receiverKey: Key, ccTag: Data? = nil, receive: Bool) throws -> Key {
        var handle = LocalKeyHandle()
