...
# Fix identifiers of the library
echo "Fixing identifiers of the library..."
install_name_tool -id  @rpath/$FRAMEWORK_NAME/$FRAMEWORK_LIBRARY_NAME $OUT_PATH/$XC_FRAMEWORK_NAME/ios-arm64/$FRAMEWORK_NAME/$FRAMEWORK_LIBRARY_NAME
install_name_tool -id  @rpath/$FRAMEWORK_NAME/$FRAMEWORK_LIBRARY_NAME $OUT_PATH/$XC_FRAMEWORK_NAME/ios-arm64_x86_64-simulator/$FRAMEWORK_NAME/$FRAMEWORK_LIBRARY_NAME
install_name_tool -id  @rpath/$FRAMEWORK_NAME/$FRAMEWORK_LIBRARY_NAME $OUT_PATH/$XC_FRAMEWORK_NAME/macos-arm64_x86_64/$FRAMEWORK_NAME/$FRAMEWORK_LIBRARY_NAME
